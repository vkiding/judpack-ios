...
#import "judPluginConfigParser.h"
@interface judPluginLoader ()
...
@implementation judPluginLoader

@synthesize configParser;

+ (NSArray *)getPlugins
{
    judPluginConfigParser *delegate = [[judPluginConfigParser alloc] init];
...
+ (void)parseSettingsWithParser:(NSObject <NSXMLParserDelegate>*)delegate
{
    ...
    NSString* path = [self configFilePath:@"judpluginConfig.xml"];
